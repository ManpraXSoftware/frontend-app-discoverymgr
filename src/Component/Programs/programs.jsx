import { Button, Container, DataTable, Icon, IconButton, Pagination, SearchField, Form, Modal, CardView, Card } from '@edx/paragon';
...
const Programs = () => {
    ...
    async function getPrograms(page) {
        const response = await getAuthenticatedHttpClient().get(process.env.DISCOVERY_BASE_URL + `/api/mx/program_data/?page=${page}&page_size=${page_size}&q=${searh}&status=${status}`);
